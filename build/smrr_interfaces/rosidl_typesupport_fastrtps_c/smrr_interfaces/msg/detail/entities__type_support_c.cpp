...
#include "smrr_interfaces/msg/detail/entities__rosidl_typesupport_fastrtps_c.h"
...
using _Entities__ros_msg_type = smrr_interfaces__msg__Entities;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Entities__ros_msg_type * ros_message = static_cast<const _Entities__ros_msg_type *>(untyped_ros_message);
  // Field name: count
  {
  ...
  void * untyped_ros_message)
{
  ...
  _Entities__ros_msg_type * ros_message = static_cast<_Entities__ros_msg_type *>(untyped_ros_message);
  // Field name: count
  {
    cdr >> ros_message->count;
  }
...
size_t get_serialized_size_smrr_interfaces__msg__Entities(
  const void * untyped_ros_message,
...
static uint32_t _Entities__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_smrr_interfaces__msg__Entities(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_smrr_interfaces
size_t max_serialized_size_smrr_interfaces__msg__Entities(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = smrr_interfaces__msg__Entities;
    is_plain =
      (
      offsetof(DataType, y) +
      last_member_size
...
static size_t _Entities__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_smrr_interfaces__msg__Entities(
...
static message_type_support_callbacks_t __callbacks_Entities = {
  "smrr_interfaces::msg",
  "Entities",
...
static rosidl_message_type_support_t _Entities__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_Entities,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, smrr_interfaces, msg, Entities)() {
  return &_Entities__type_support;
}
