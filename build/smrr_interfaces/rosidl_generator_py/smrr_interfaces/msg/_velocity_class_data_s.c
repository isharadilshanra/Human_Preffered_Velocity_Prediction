...
bool smrr_interfaces__msg__velocity_class_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("smrr_interfaces.msg._velocity_class_data.VelocityClassData", full_classname_dest, 58) == 0);
  }
  smrr_interfaces__msg__VelocityClassData * ros_message = _ros_message;
  {  // class_ids
...
{
  /* NOTE(esteve): Call constructor of VelocityClassData */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("smrr_interfaces.msg._velocity_class_data");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "VelocityClassData");
