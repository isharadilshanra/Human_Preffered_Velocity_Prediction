...
bool smrr_interfaces__msg__entities__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("smrr_interfaces.msg._entities.Entities", full_classname_dest, 38) == 0);
  }
  smrr_interfaces__msg__Entities * ros_message = _ros_message;
  {  // count
...
{
  /* NOTE(esteve): Call constructor of Entities */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("smrr_interfaces.msg._entities");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Entities");
